...
bench get-app kenya_compliance_via_digitax "${GITHUB_WORKSPACE}"

bench setup requirements --dev

# setuptools is required by packages that import pkg_resources.
...
bench --verbose --site test_site install-app kenya_compliance_via_digitax
