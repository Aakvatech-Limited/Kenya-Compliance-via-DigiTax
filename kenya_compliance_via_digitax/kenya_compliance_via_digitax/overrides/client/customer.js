...
function executeCustomerAction(frm, actionType, settingsName) {
	...
	if (frm.doc.etims_setup_mapping) {
		...
		digitaxId = mappingRow ? mappingRow.digitax_id : "";
	}
	...
	switch (actionType) {
		...
		case "update_customer":
			method =
				"kenya_compliance_via_digitax.kenya_compliance_via_digitax.apis.apis.send_customer_details";
			args = {
				name: frm.doc.name,
		...
		case "get_customer_details":
			method =
				"kenya_compliance_via_digitax.kenya_compliance_via_digitax.apis.apis.get_customer_details";
			args = {
				settings_name: settingsName,
				request_data: {
