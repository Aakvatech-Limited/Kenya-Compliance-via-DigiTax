...
class DigiTaxeTimsSettings(Document):
	...
	if TYPE_CHECKING:
		...
		codes_refresh_frequency: DF.Literal[
			"", "All", "Hourly", "Daily", "Weekly", "Monthly", "Yearly", "Annual", "Cron"
		]
		company: DF.Link
		...
		notices_refresh_frequency: DF.Literal[
			"", "All", "Hourly", "Daily", "Weekly", "Monthly", "Yearly", "Annual", "Cron"
		]
		...
		purchase_information_submission: DF.Literal[
			"", "All", "Hourly", "Daily", "Weekly", "Monthly", "Yearly", "Annual", "Cron"
		]
		...
		sales_information_submission: DF.Literal[
			"", "All", "Hourly", "Daily", "Weekly", "Monthly", "Yearly", "Annual", "Cron"
		]
		...
		stock_information_submission: DF.Literal[
			"", "All", "Hourly", "Daily", "Weekly", "Monthly", "Yearly", "Annual", "Cron"
		]
